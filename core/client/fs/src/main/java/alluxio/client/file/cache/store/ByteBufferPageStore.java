...
/**
 * The {@link ByteBufferPageStore} is an implementation of {@link PageStore} which
 * stores all pages in a buffer.
 */
@NotThreadSafe
public class ByteBufferPageStore implements PageStore {
  ...
  // TODO(zhichao zhang): add to Errno
  ...
  /**
   * Creates a new instance of {@link ByteBufferPageStore}.
   *
